...
authorToEdit :: Author
authorToEdit = AuthorToEdit {authorId = 1,
    description = "edit"}

authorToCreate :: Author
authorToCreate = AuthorToCreate { userId = 1, 
    description = "create" }

authorToGet :: Author
authorToGet = AuthorToGet { authorId = 1,
        userId = 1, description = "get" }